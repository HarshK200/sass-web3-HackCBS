            ...
            <div className="flex flex-col items-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl dark:text-gray-400">
                  Join our community of data labelers and earn cryptocurrency
          ...
          <div className="container px-4 md:px-6 mx-auto">
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              <Card>
                ...
                <CardContent>
                  <p>
                    Earn cryptocurrency for every correctly labeled data point.
                  </p>
                </CardContent>
              </Card>
              <Card>
              ...
              <Card>
                ...
                <CardContent>
                  <p>
                    Join a global community of data labelers and AI enthusiasts.
                  </p>
                </CardContent>
              </Card>
            </div>
            ...
            <div className="flex flex-col items-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="mx-auto max-w-[600px] text-gray-500 md:text-xl dark:text-gray-400">
                  Join thousands of data labelers who are already earning
                  cryptocurrency.
                </p>
              </div>
